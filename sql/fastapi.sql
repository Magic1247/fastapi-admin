...
values (100, 0, '0', '集团总公司', 0, '怀光', '15888888888', 'sky@wuchuan.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept
values (101, 100, '0,100', '深圳分公司', 1, '怀光', '15888888888', 'sky@wuchuan.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (102, 100, '0,100', '北京分公司', 2, '怀光', '15888888888', 'sky@wuchuan.com', '0', '0', 'admin', sysdate(), '',
        null);
insert into sys_dept
values (103, 101, '0,100,101', '研发部门', 1, '怀光', '15888888888', 'sky@wuchuan.com', '0', '0', 'admin', sysdate(),
        '',
        null);
insert into sys_dept
values (104, 101, '0,100,101', '市场部门', 2, '怀光', '15888888888', 'sky@wuchuan.com', '0', '0', 'admin', sysdate(),
        '',
        null);
insert into sys_dept
values (105, 101, '0,100,101', '测试部门', 3, '怀光', '15888888888', 'sky@wuchuan.com', '0', '0', 'admin', sysdate(),
        '',
        null);
insert into sys_dept
values (106, 101, '0,100,101', '财务部门', 4, '怀光', '15888888888', 'sky@wuchuan.com', '0', '0', 'admin', sysdate(),
        '',
        null);
insert into sys_dept
values (107, 101, '0,100,101', '运维部门', 5, '怀光', '15888888888', 'sky@wuchuan.com', '0', '0', 'admin', sysdate(),
        '',
        null);
insert into sys_dept
values (108, 102, '0,100,102', '市场部门', 1, '怀光', '15888888888', 'sky@wuchuan.com', '0', '0', 'admin', sysdate(),
        '',
        null);
insert into sys_dept
values (109, 102, '0,100,102', '财务部门', 2, '怀光', '15888888888', 'sky@wuchuan.com', '0', '0', 'admin', sysdate(),
        '',
        null);
...
values (1, 103, 'admin', '超级管理员', '00', 'zyhttx@gmail.com', '15688888888', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin',
        sysdate(), '', null, '管理员');
insert into sys_user
values (2, 105, 'huaiguang', '怀光', '00', 'zyhttx@gmail.com', '15666666666', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin',
        sysdate(), '', null, '测试员');
...
insert into sys_dict_data
values (31, 1, '成功', '0', 'sys_common_status', '', 'primary', 'N', '0', 'admin', sysdate(), '', null, '正常状态');
insert into sys_dict_data
values (32, 2, '失败', '1', 'sys_common_status', '', 'danger', 'N', '0', 'admin', sysdate(), '', null, '停用状态');
